...
@Schema(
        name = "Exemplo Resposta Paginada de Espécies",
        description = "Exemplo de resposta paginada contendo uma lista de espécies"
)
public class ExemploRespostaPageEspecie {

    @Schema(description = "Lista de espécies retornadas na página atual", example = "[{\"id\": \"507f1f77bcf86cd799439011\", \"nome\": \"Cachorro\"}]")
    private List<EspecieResDTO> content;
    ...
    public ExemploRespostaPageEspecie() {
    }

    public List<EspecieResDTO> getContent() {
        return content;
    }

    public void setContent(List<EspecieResDTO> content) {
