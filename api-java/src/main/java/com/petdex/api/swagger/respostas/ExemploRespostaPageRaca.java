...
@Schema(
        name = "Exemplo Resposta Paginada de Raças",
        description = "Exemplo de resposta paginada contendo uma lista de raças"
)
public class ExemploRespostaPageRaca {

    @Schema(description = "Lista de raças retornadas na página atual", example = "[{\"id\": \"507f1f77bcf86cd799439011\", \"nome\": \"Labrador\", \"especie\": \"507f1f77bcf86cd799439011\"}]")
    private List<RacaResDTO> content;
    ...
    public ExemploRespostaPageRaca() {
    }

    public List<RacaResDTO> getContent() {
        return content;
    }

    public void setContent(List<RacaResDTO> content) {
